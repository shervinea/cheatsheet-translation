...
<div dir="rtl">
خطای تخمین و تقریب - خطای تقریب $\epsilon_{approx}$ نشان‌دهنده‌ی میزان دوری کلاس فرضیه $F$ از پیش‌بینی‌گر هدف $g^*$ است، در حالی که خطای تخمین $\epsilon_{est}$ خوب بودن $\hat{f}$ نسبت به بهترین
پیش‌بینی‌گر $f^*$ از کلاس فرضیه $F$ را اندازه‌گیری می‌کند.
</div>
...
<div dir="rtl">
[ضرایب را تا ۰ کاهش می‌دهد، برای انتخاب متغیر مناسب است، ضرایب را کوچکتر می‌کند
...
رویه‌ی تحلیل مولفه‌های اصلی یک روش کاهش ابعاداست که داده‌ها را در فضای $k$-بعدی با بیشینه کردن واریانس داده‌ها، به صورت زیر تصویر می‌کند:
...
[یادگیری بدون نظارت، $k$-میانگین، تحلیل مؤلفه‌های مستقل]
