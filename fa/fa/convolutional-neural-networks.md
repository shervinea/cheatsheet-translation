...
<div dir="rtl">
ابعاد یک فیلتر – یک فیلتر به اندازه F×F اعمال شده برروی یک ورودیِ حاوی C کانال، یک توده F×F×C است که (عملیات) پیچشی برروی یک ورودی به اندازه I×I×C اعمال میکند و یک نگاشت ویژگی خروجی (که همچنین نگاشت فعالسازی نامیده میشود) به اندازه 0×0×1 تولید میکند.
</div> 
<br>
...
<div dir="rtl">
نکته: اعمال K فیلتر به اندازه F×F، منتج به یک نگاشت ویژگی خروجی به اندازه 0×0×k می‌شود.
</div> 
<br>
