...
<div dir="rtl">
[معماری ترفند محاسبات، شبکه مولد تخاصمی، معماری ResNet، شبکه ابتکاری  ]
</div>
<br>
...
<div dir="rtl">
 لایه پیچشی -  لایه پیچشی از فیلتری استفاده میکند که انجام عملیات پیچش با توجه به اهمیت ابعاد داده‌ها را از ورودی میگیرد. این فرادانسته‌ها شامل سایز فیلتر(F) و گام(S) میشود. نام نتیجه خروجی(O) نگاشت ویژگی یا نگاشت فعال‌ساز است.
</div>  
<br>
...
<div dir="rtl">
لایه کانولوشنی شامل فیلتر‌های مهمی است، که باید معنی نهفته در پس ابرفراسنج‌ها را درک کرد. 
</div>  
<br>
...
<div dir="rtl">
لایه گذاری - صفر - لایه گذاری- صفر نشان دهنده روند اضافه کردن  مقدار یا ماتریس صفر P به هر کدام از مرزهای ورودی است. که این مقدار میتواند به صورت مشخص و دستی یا به صورت اتوماتیک جایگزاری بشود به یکی از سه روش زیر:
</div>
<br>
...
<div dir="rtl">
[حالت، مقدار، نگاره، هدف، موثر، یکسان، انباشته]
</div>
<br>
...
<div dir="rtl">
[بدون لایه گذاری، حذف لایه کانولوشنی در صورت  هماهنگ نبودن ابعاد، لایه گذاری که سایز نگاشت ویژگی به صورت ⌈IS⌉ است، سایز خروجی با محاسبات ساده بدست می‌آید. به این مدل لایه گذاری نصفه می‌گویند.حداکثر لایه گذاری در نهایت در لایه پیچشی در ورودی محدود اعمال می‌شود، فیلتر 'sees' به صورت (end-to-end) پایان به پایان]
</div>
<br>
...
<div dir="rtl">
شبکه ابتکاری -  این معماری از ماژول ابتکاری استفاده می‌کند، و  هدف استفاده از نوع متفاوتی از شبکه پیچشی در جهت  افزایش کارایی، از طریق افزایش ویژگی‌ها است. بخصوص که استفاده از مدل 1×1 پیچشی در جهت ترفند‌های محاسباتی محدود است.
</div> 
<br>
