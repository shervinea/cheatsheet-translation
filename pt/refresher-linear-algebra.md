...
&#10230; Observação: nós também indicasmos D como diag(d1,...,dn).
...
&#10230; Observação: nem todas as matrizes quadrada são inversíveis. Também, para matrizes A,B, temos (AB)−1=B−1A−1
...
&#10230; [Noema, Notação, Definição, Caso de uso]
...
**44. Eigenvalue, eigenvector ― Given a matrix A∈Rn×n, λ is said to be an eigenvalue of A if there exists a vector z∈Rn∖{0}, called eigenvector, we have:**
