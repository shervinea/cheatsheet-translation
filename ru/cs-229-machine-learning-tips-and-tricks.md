...
&#10230; [Прогнозируемый класс, Фактический класс]
...
&#10230; Полнота показывает, какая часть положительных наблюдений была выделена классификатором

<br>

**11. Coverage of actual negative sample**

&#10230; Спецификация показывает, какая часть отрицательных наблюдений была выделена классификатором
...
&#10230; [Усложнить модель, Добавить больше параметров, Тренировать дольше, Выполнить регуляризацию, Собрать больше данных]
