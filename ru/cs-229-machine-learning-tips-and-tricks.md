...
&#10230; where L is the likelihood and ˆσ2 is an estimate of the variance associated with each response.
...
&#10230; [Usually 80% of the dataset, Usually 20% of the dataset]

<br>

**27. [Also called hold-out or development set, Unseen data]**

&#10230; [Also called hold-out or development set, Unseen data]
...
&#10230; [Symptoms, Regression illustration, classification illustration, deep learning illustration, possible remedies]

<br>

**40. [High training error, Training error close to test error, High bias, Training error slightly lower than test error, Very low training error, Training error much lower than test error, High variance]**

&#10230; [High training error, Training error close to test error, High bias, Training error slightly lower than test error, Very low training error, Training error much lower than test error, High variance]

<br>

**41. [Complexify model, Add more features, Train longer, Perform regularization, Get more data]**

&#10230; [Complexify model, Add more features, Train longer, Perform regularization, Get more data]
...
&#10230; [Classification metrics, confusion matrix, accuracy, precision, recall, F1 score, ROC]

<br>

**46. [Regression metrics, R squared, Mallow's CP, AIC, BIC]**

&#10230; [Regression metrics, R squared, Mallow's CP, AIC, BIC]
...
&#10230; [Diagnostics, Bias/variance tradeoff, error/ablative analysis]
