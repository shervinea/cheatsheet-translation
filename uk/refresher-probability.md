...
&#10230; Простір елементарних подій ― Множина всіх можливих наслідків експерименту називається простором елементарних подій і позначається літерою S.

<br>

**4. Event ― Any subset E of the sample space is known as an event. That is, an event is a set consisting of possible outcomes of the experiment. If the outcome of the experiment is contained in E, then we say that E has occurred.**

&#10230; Випадкова подія - будь яка підмножина E що належить до певного простору елементарних подій називається подією. Таким чином, подія це множина що містить можливі наслідки експерименту. Якщо наслідки експерименту містяться в Е, тоді ми говоримо що  Е відбулася.
...
&#10230; Аксіома 1 - Всі ймовірності існують між 0 та 1.
...
&#10230; Аксіома 3 - Для будь-якої послідовності взаємно виключних подій E1,...,En, ми маємо:
...
&#10230; Сполука - сполука це спосіб вибору r об'єктів з набору n об'єктів, де порядок не має значення. Кількість таких способів вибору задається через C(n,r):
...
&#10230; Розбиття множини - Нехай {Ai,i∈[[1,n]]} буде таким для всіх i, Ai≠∅. Ми називаємо {Ai} розбиттям множини якщо:
...
&#10230; Розгорнута форма теореми Баєса - Нехай {Ai,i∈[[1,n]]} буде розбиттям множини простору елементарних подій. Маємо:
...
&#10230; Випадкова величина - Випадкова величина, часто означена X, є функцією що проектує кожну подію в просторі елементарних подій на реальну лінію.
...
&#10230; Залежність між PDF та CDF - Ось деякі важливі характеристики:
...
&#10230; Математичне сподівання і моменти випадкової величини - Ось вирази очікуваної величини E[X], узагальненої очікуваної величини E[g(X)], k-го моменту E[Xk] та характеристичною функцією ψ(ω) дискретної або неперервної випадкової величини:

<br>

**28. Variance ― The variance of a random variable, often noted Var(X) or σ2, is a measure of the spread of its distribution function. It is determined as follows:**

&#10230; Дисперсія випадкової величини - Дисперсія випадкової величини, що позначається Var(X) або σ2 є мірою величини розподілення значень Функції. Вона визначаєтья:
