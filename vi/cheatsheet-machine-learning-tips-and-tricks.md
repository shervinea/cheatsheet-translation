...
&#10230; Trong ngữ cảnh của phân loại nhị phân (binary classification), ở đây là các ma trận chính, chúng khá quan trọng để theo dõi (track), qua đó đánh giá hiệu năng của mô hình (model)
...
&#10230; Số liệu chính - Các số liệu sau thường được sử dụng để đánh giá hiệu năng của mô hình phân loại:

<br>

**7. [Metric, Formula, Interpretation]**

&#10230; [Số liệu, Công thức, Diễn giải]
...
&#10230; Các số liệu Hybrid hữu ích cho các lớp không cân bằng (unbalanced classes)
